      ...
      <div className="h-fit relative py-10 bg-lightblue">
        ...
        <div className="flex md:flex-row flex-col justify-center items-center gap-20 md:gap-5">
          ...
          >
            ...
            <p className="text-lg line-clamp-5">
              Explore the world of robotics engineering at AMURoboclub, where
              creativity and precision converge. We empower students to bring
              their ideas to life, encouraging exploration across domains such
              as machine learning, embedded systems, and mechanical engineering.
            </p>
            <a className="text-lg font-medium hover:text-red-800">
              Join the Movement
            </a>
          </motion.div>
        </div>
