        ...
        <div className="flex flex-col md:flex-row md:justify-between items-stretch md:items-center gap-4 mb-8">
          <div className="flex w-full md:max-w-xl">
            <input
              ...
              className="flex-1 px-4 py-3 rounded bg-gray-800 border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          <div className="flex justify-center md:justify-end">
            <div className="inline-block bg-gray-900/30 border border-green-400/20 rounded-lg px-4 py-2 backdrop-blur-sm">
              <span className="text-gray-400 font-mono text-sm">SHOWING: </span>
                  ...
                  <div className="relative space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-white font-mono text-base">{member.enrollmentNumber}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <IdCard className="text-purple-400 w-3 h-3" />
                        <span className="text-white font-mono text-base">{member.facultyNumber}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Calendar className="text-yellow-400 w-3 h-3 flex-shrink-0" />
                        <div>
                          <span className="text-gray-400 text-xs font-mono">MEMBER SINCE: </span>
