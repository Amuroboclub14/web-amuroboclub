    ...
    >
      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm !font-mono">📍 AMU, Aligarh</p>
      ...
      <div className="flex md:flex-row flex-col items-center justify-between !font-mono border-t border-gray-600 pt-6">
        ...
        <div className="flex items-center gap-5">
          <a
            href="https://www.linkedin.com/company/amuroboclub/?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BGvhzPw1ES5CjysMwoTzrWA%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:bg-white transition-all duration-200 hover:rounded-full p-2 group"
          >
            <svg
              className="w-6 h-6 fill-current group-hover:fill-mainblue"
          ...
          <a
            href="https://www.instagram.com/amuroboclub?igsh=eWtoeGIzOXFvZW5u"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:bg-white transition-all duration-200 hover:rounded-full p-2 group"
          >
