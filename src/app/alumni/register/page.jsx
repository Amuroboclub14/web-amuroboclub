              ...
              <div className="flex flex-col gap-2">
                ...
                {photoPreviewUrl && (
                  <div className="relative inline-block mt-2">
                    <div className="relative w-full max-w-[220px] aspect-square rounded-xl overflow-hidden border border-gray-600 bg-gray-800">
                      <img
                        src={photoPreviewUrl}
                        alt="Preview"
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-8 h-8 rounded-full bg-red-500/90 hover:bg-red-500 text-white flex items-center justify-center shadow-lg transition-colors"
                      >
                    ...
                    <p className="text-gray-500 text-xs mt-1">Click the × to remove</p>
                  </div>
                )}
              </div>
              <div className="flex flex-col gap-2">
